...
public class HungerMI extends MenuItem
{
    private static final String iName = "Hunger";
    private static final Material iMaterial = Material.BREAD;
    private static final ArrayList<String> iLore = null;

    private Group group;

    public HungerMI (String name, int slot, Menu holder, Group group)
    {
