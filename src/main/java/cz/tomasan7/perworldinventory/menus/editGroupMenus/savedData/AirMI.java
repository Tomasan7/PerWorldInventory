...
public class AirMI extends MenuItem
{
    private static final String iName = "Air";
    private static final Material iMaterial = Material.GLASS_BOTTLE;
    private static final ArrayList<String> iLore = null;

    private Group group;

    public AirMI (String name, int slot, Menu holder, Group group)
    {
