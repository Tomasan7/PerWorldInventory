...
public class EnderChestMI extends MenuItem
{
    private static final String iName = "EnderChest";
    private static final Material iMaterial = Material.ENDER_CHEST;
    private static final ArrayList<String> iLore = null;

    private Group group;

    public EnderChestMI (String name, int slot, Menu holder, Group group)
    {
