...
public class ExpMI extends MenuItem
{
    private static final String iName = "Experience";
    private static final Material iMaterial = Material.EXPERIENCE_BOTTLE;
    private static final ArrayList<String> iLore = null;

    private Group group;

    public ExpMI (String name, int slot, Menu holder, Group group)
    {
