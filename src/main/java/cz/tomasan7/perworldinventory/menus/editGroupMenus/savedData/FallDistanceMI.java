...
public class FallDistanceMI extends MenuItem
{
    private static final String iName = "FallDistance";
    private static final Material iMaterial = Material.POTION;
    private static final ArrayList<String> iLore = null;

    private Group group;

    public FallDistanceMI (String name, int slot, Menu holder, Group group)
    {
