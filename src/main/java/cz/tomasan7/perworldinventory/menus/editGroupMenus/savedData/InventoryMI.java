...
public class InventoryMI extends MenuItem
{
    private static final String iName = "Inventory";
    private static final Material iMaterial = Material.CHEST;
    private static final ArrayList<String> iLore = null;

    private Group group;

    public InventoryMI (String name, int slot, Menu holder, Group group)
    {
